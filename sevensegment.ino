    ...
    for (int z = 0; z < n.length(); z++)
        for (int i = 0; i < 5; i++)
            for (int j = 0; j < 3; j++)
            {
                ...
                int b = c.toInt();
                M5.Lcd.fillRoundRect((z * (sizee * 4)) + fromLeft + (j * sizee) + (j * space), fromTop + (i * sizee) + (i * space), sizee, sizee, Round, colors[arr[b][i][j]]);
                // delay(20);
            }
}
    ...
    for (int m = 1; m < 21; m++)
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            if (i <= (f - 1))
            {
                for (int j = 0; j < 3; j++)
                {
                    M5.Lcd.fillRoundRect((z * (sizee * 4)) + fromLeft + (j * sizee) + (j * space), fromTop + (i * sizee) + (i * space), sizee, sizee, Round, (digit == 10) ? colors[arr[10][i][j]] : colors[arr[b][i][j]]);
                    // delay(20);
                }
            }
            else
            {
                ...
                {
                    int rnd = random(2);
                    M5.Lcd.fillRoundRect((z * (sizee * 4)) + fromLeft + (j * sizee) + (j * space), fromTop + (i * sizee) + (i * space), sizee, sizee, Round, colors[rnd]);
                }
            }
            if (i == 4 && f == 4)
            {
            ...
            for (int k = 0; k < 5; k++)
            {
                ...
                for (int j = 0; j < 3; j++)
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (rnda < 2)
                                M5.Lcd.fillRoundRect((z * (sizee * 4)) + fromLeft + (j * sizee) + (j * space), fromTop + (i * sizee) + (i * space), sizee, sizee, Round, colors[arr[10][i][j]]);
                            else
                                M5.Lcd.fillRoundRect((z * (sizee * 4)) + fromLeft + (j * sizee) + (j * space), fromTop + (i * sizee) + (i * space), sizee, sizee, Round, colors[rnd]);
                        }
                        else
...
//             //         if (state)
//             //             M5.Lcd.fillCircle(tmpDigit[tmpRow[row]][tmpCol[col]][0], tmpDigit[tmpRow[row]][tmpCol[col]][1], r, colorrnd);
//             //         delay(40);
//             //     }
//             //     delay(40);
//             // }
...
//                         {
//                             M5.Lcd.fillCircle(tmpDigit[row][col][0], tmpDigit[row][col][1], r, colorrnd);
//                             match = true;
//                         }
//                         // delay(40);
//                     }
...
//             //         bool state = DIGITS[curr_digit][tmpRow[row]][tmpCol[col]];
//             //         if (state)
//             //             M5.Lcd.fillRoundRect(x_start - r + tmpCol[col] * 7, y_start - r + tmpRow[row] * 7, r * 1, r * 1, 0, colorrnd);
...
//                         if (state == patternSequences[i])
//                         {
//                             M5.Lcd.fillRoundRect(x_start - r + col * 7, y_start - r + row * 7, r * 1, r * 1, 0, colorrnd);
//                             match = true;
//                         }
//                         // delay(40);
//                     }
...
//                     {
//                         int xc = x_start + col * 8 - 1 + (random(4));
//                         int yc = y_start + row * 8 - 1 + (random(4));
...
//                 // M5.Lcd.drawLine(130, 62, 132, 64, colll);
//                 if (xpath[i + 1] != 0)
//                 {
//                     if (curr_digit == 0)
//                     {
//                         //   M5.Lcd.drawBoldLine(xpath[i], ypath[i], xpath[i + 1], ypath[i + 1], 4, colll);
//                         M5.Lcd.drawWideLine(xpath[i], ypath[i], xpath[i + 1], ypath[i + 1], 10, colll, bcoll);
//                         if (i > 0)
//                             M5.Lcd.drawBoldLine(xpath[i - 1], ypath[i - 1], xpath[i], ypath[i], 4, colll);
//                         if (i == 1)
//                             M5.Lcd.drawBoldLine(xpath[i - 1], ypath[i - 1], xpath[15], ypath[15], 4, colll);

//                         // M5.Lcd.drawLine(xpath[i], ypath[i], xpath[i + 1], ypath[i + 1], colll);
//                         if (i == 0)
//                             //   M5.Lcd.drawBoldLine(xpath[i], ypath[i], xpath[15], ypath[15], 4, colll);
//                             M5.Lcd.drawWideLine(xpath[i], ypath[i], xpath[15], ypath[15], 10, colll, bcoll);
...
//                         if (i == 6)
//                         {
//                             //   M5.Lcd.drawBoldLine(xpath[i], ypath[i], xpath[9], ypath[9], 4, colll);
//                             M5.Lcd.drawWideLine(xpath[i], ypath[i], xpath[8], ypath[8], 10, colll, bcoll);
...
//                             if (i == 7)
//                             {
//                                 M5.Lcd.drawBoldLine(xpath[i - 2], ypath[i - 2], xpath[6], ypath[6], 4, colll);
//                             }
//                             M5.Lcd.drawWideLine(xpath[i], ypath[i], xpath[i + 1], ypath[i + 1], 10, colll, bcoll);
//                             if (i > 0 && i - 1 != 6)
//                                 M5.Lcd.drawBoldLine(xpath[i - 1], ypath[i - 1], xpath[i], ypath[i], 4, colll);
...
//                             if (i == 8)
//                             {
//                                 M5.Lcd.drawWideLine(xpath[6], ypath[6], xpath[8], ypath[8], 10, colll, colll);
//                                 M5.Lcd.drawWideLine(xpath[1], ypath[1], xpath[3], ypath[3], 10, colll, colll);
//                             }
//                         }
//                     }
...
//                             //   M5.Lcd.drawBoldLine(xpath[i], ypath[i], xpath[i + 1], ypath[i + 1], 4, colll);
//                             if (i == 8)
//                                 //   M5.Lcd.drawBoldLine(xpath[i], ypath[i], xpath[8], ypath[8], 4, colll);
//                                 M5.Lcd.drawWideLine(xpath[i - 2], ypath[i - 2], xpath[8], ypath[8], 10, colll, bcoll);
//                             if (i == 9)
//                             {
//                                 M5.Lcd.drawBoldLine(xpath[6], ypath[6], xpath[7], ypath[7], 4, colll);
//                                 M5.Lcd.drawBoldLine(xpath[6], ypath[6], xpath[5], ypath[5], 4, colll);
//                             }
//                             // M5.Lcd.drawLine(xpath[i], ypath[i], xpath[8], ypath[8], colll);
//                         }

//                         else // i==7
//                             M5.Lcd.drawBoldLine(xpath[i - 1], ypath[i - 1], xpath[8], ypath[8], 4, colll);
//                     }
...
//                         if (i == 0)
//                             //   M5.Lcd.drawBoldLine(xpath[i], ypath[i], xpath[9], ypath[9], 4, colll);
//                             M5.Lcd.drawWideLine(xpath[i], ypath[i], xpath[9], ypath[9], 10, colll, bcoll);
//                         // M5.Lcd.drawLine(xpath[i], ypath[i], xpath[9], ypath[9], colll);
//                         if (i == 1)
//                         //   M5.Lcd.drawBoldLine(xpath[i], ypath[i], xpath[16], ypath[16], 4, colll);
//                         {
//                             M5.Lcd.drawWideLine(xpath[i], ypath[i], xpath[16], ypath[16], 10, colll, bcoll);
//                             M5.Lcd.drawBoldLine(xpath[i - 1], ypath[i - 1], xpath[9], ypath[9], 4, colll);
//                         }
//                         if (i == 2)
//                             M5.Lcd.drawBoldLine(xpath[i - 1], ypath[i - 1], xpath[16], ypath[16], 4, colll);
//                         if (i == 15)
//                         {
//                             M5.Lcd.drawBoldLine(xpath[1], ypath[1], xpath[16], ypath[16], 4, colll);
//                             M5.Lcd.drawBoldLine(xpath[0], ypath[0], xpath[1], ypath[1], 4, colll);
//                             M5.Lcd.drawBoldLine(xpath[0], ypath[0], xpath[9], ypath[9], 4, colll);
//                         }
...
//                         if (i > 0)
//                             M5.Lcd.drawBoldLine(xpath[i - 1], ypath[i - 1], xpath[i], ypath[i], 4, colll);
//                         // M5.Lcd.drawWideLine(xpath[-i], ypath[-i], xpath[i], ypath[i], 6, colll, bcoll);
//                         // M5.Lcd.drawBoldLine(xpath[i], ypath[i], xpath[i + 1], ypath[i + 1], 4, colll);
//                     }
//                     delay(50);
//                 }
        ...
        for (int pos = 1; pos < 4; pos++)
        {
            ...
            for (int row = startrow; row < 7; row++)
            {
                for (int col = 0; col < 5; col++)
                {
                    ...
                    // if (DIGITS[curr_digit][row][col] == 1)
                    bool state = DIGITS[curr_digit][row][col];
                    tmpDigit[row][col][0] = x_start + col * 5 - 1 + random(4);
                    tmpDigit[row][col][1] = y_start + row * 5 - 1 + random(4);
                    // M5.Lcd.fillCircle(x_start + col * 7 - 1 + random(4), y_start + row * 7 - 1 + random(4), r, colorrnd);
                }
            }
            // suffling row order
    ...
    else if (clock_style == 2)
    {
        ...
        for (int pos = 1; pos < 4; pos++)
        {
            ...
            for (int i = 0; i < 19; i++)
            {
                ...
                // Serial.printf("curdigit[%d] xpath[%d] : %d \n", curr_digit, i);
                // M5.Lcd.drawLine(130, 62, 132, 6colll);
                if (xpath[i + 1] != 0)
                {
                    if (curr_digit == 0)
                    {
